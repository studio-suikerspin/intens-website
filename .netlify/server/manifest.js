...
return {
	...
	_: {
		...
		prerendered_routes: new Set(["/slice-simulator","/slice-simulator/__data.json","/","/__data.json","/projecten/waterschade-herstel-westerpoort","/projecten/waterschade-herstel-westerpoort/__data.json","/projecten/preventief-onderhoud-bedrijfscomplex-noord","/projecten/preventief-onderhoud-bedrijfscomplex-noord/__data.json","/projecten/kantoorpand-a1","/projecten/kantoorpand-a1/__data.json","/contact","/contact/__data.json","/diensten","/diensten/__data.json","/projecten","/projecten/__data.json","/over-ons","/over-ons/__data.json"]),
		matchers: async () => {
