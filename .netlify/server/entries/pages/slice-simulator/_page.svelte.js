...
import { z as sanitize_props, F as attr_class, G as attr_style, J as stringify, K as clsx, N as slot, O as bind_props } from "../../../chunks/index2.js";
...
const statuses = /* @__PURE__ */ getDefaultExportFromCjs(statusesExports);
...
const createSuccessResponseMessage = (requestID2, data, status = 200) => {
  ...
  return {
    ...
    status,
    msg: ((_a2 = statuses.message[status]) == null ? void 0 : _a2.replace(/\.$/, "").toLowerCase()) ?? "",
    data
  };
};
